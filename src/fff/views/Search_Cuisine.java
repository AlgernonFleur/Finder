...
public class Search_Cuisine extends _View_ {
	...
	@FXML public void initialize(){
		...
		searchBox.setItems(getCurrentCuisines());
	...
	private void search(){
		ObservableList<Restaurant> results =
			Search.getSearchResultsCuisine(_Overview_.getDatabase().getRestaurants(), searchBox.getValue());
		if(results.size()==0){
